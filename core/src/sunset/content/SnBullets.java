...
public class SnBullets implements ContentList {
    ...
    public void load() {
        ...
        smallBlueMissile = new BasicBulletType(5f, 55, "missile") {{//yes
            shrinkX = 0f;
            shrinkY = 0f;
            lifetime = 45f;
            height = 15f;
        ...
        bigHelicopterMissile = new MissileBulletType(4.7f, 22) {{
            width = 9f;
            height = 14f;
            shrinkY = 0f;
            drag = -0.003f;
        ...
        largeHelicopterMissile = new BasicBulletType(6.3f, 65, "missile-large") {{
            width = 14f;
            height = 17f;
            hitShake = 3f;
            lifetime = 46f;
        ...
        smallHelicopterMissile = new MissileBulletType(4.4f, 45) {{
            width = 11f;
            height = 11f;
            shrinkY = 0f;
            lifetime = 60f;
