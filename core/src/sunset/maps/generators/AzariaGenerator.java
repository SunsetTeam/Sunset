...
public class AzariaGenerator extends SnPlanetGenerator{
    ...
    public AzariaGenerator(){
         arr = new Block[][]{
        {SnEnvironment.crimsonwater, SnEnvironment.crimsondirt, SnEnvironment.crimsongrass, SnEnvironment.crimsonwater, SnEnvironment.crimsonswamp, SnEnvironment.crimsongrass, Blocks.mud, SnEnvironment.granite, SnEnvironment.granite, Blocks.mud, SnEnvironment.crimsondirt, Blocks.stone, SnEnvironment.granite},
        {SnEnvironment.crimsonwater, SnEnvironment.crimsondirt, SnEnvironment.granite, Blocks.mud, Blocks.mud, SnEnvironment.crimsongrass, SnEnvironment.granite, Blocks.mud,SnEnvironment.crimsondirt, SnEnvironment.crimsonwater, Blocks.stone, Blocks.stone, SnEnvironment.granite},
        ...
        {SnEnvironment.crimsonwater, SnEnvironment.crimsonsandwater, SnEnvironment.crimsongrass, SnEnvironment.crimsonswamp, SnEnvironment.crimsondirt, SnEnvironment.crimsonwater, SnEnvironment.crimsondirt, SnEnvironment.granite, SnEnvironment.crimsonswamp, SnEnvironment.crimsonswamp, Blocks.mud, SnEnvironment.crimsondirt, SnEnvironment.crimsongrass},
        {SnEnvironment.crimsongrass, SnEnvironment.crimsonwater, Blocks.mud, SnEnvironment.granite, SnEnvironment.crimsonwater, SnEnvironment.crimsondirt, SnEnvironment.crimsondirt, Blocks.hotrock, SnEnvironment.granite, SnEnvironment.crimsonswamp, SnEnvironment.crimsondirt, SnEnvironment.crimsonswamp, SnEnvironment.crimsongrass},
        ...
        {SnEnvironment.crimsongrass, Blocks.mud, SnEnvironment.granite, SnEnvironment.crimsondirt, SnEnvironment.crimsonswamp, SnEnvironment.granite, SnEnvironment.crimsondirt, SnEnvironment.crimsondirt, SnEnvironment.crimsondirt, SnEnvironment.crimsonwater, SnEnvironment.granite, Blocks.mud, Blocks.mud},
        {SnEnvironment.crimsondirt, SnEnvironment.granite, SnEnvironment.granite, SnEnvironment.granite, SnEnvironment.crimsondirt, SnEnvironment.crimsondirt, SnEnvironment.granite, SnEnvironment.crimsondirt, SnEnvironment.crimsonwater, Blocks.mud, SnEnvironment.crimsongrass, SnEnvironment.crimsongrass, Blocks.mud},
        {SnEnvironment.crimsongrass, SnEnvironment.crimsonsnow, Blocks.mud, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsongrass, SnEnvironment.crimsondirt, SnEnvironment.crimsonwater, Blocks.mud, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, Blocks.mud},
        {SnEnvironment.crimsonsnow, SnEnvironment.granite, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsondirt, SnEnvironment.crimsondirt, SnEnvironment.crimsondirt, SnEnvironment.crimsonice, SnEnvironment.crimsonsnow, SnEnvironment.granite, SnEnvironment.granite, SnEnvironment.crimsonsnow}
        };
