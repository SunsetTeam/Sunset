...
public class AzariaGenerator extends SnPlanetGenerator{
    ...
    public AzariaGenerator(){
        ...
        {SnEnvironment.crimsongrass, SnEnvironment.crimsondirt, Blocks.mud, SnEnvironment.crimsonsnow, SnEnvironment.crimsondirt, SnEnvironment.crimsonsnow, SnEnvironment.crimsongrass, SnEnvironment.crimsondirt, SnEnvironment.crimsonwater, Blocks.mud, SnEnvironment.crimsongrass, SnEnvironment.crimsonice, Blocks.mud},
        {SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsondirt, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonice, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow, SnEnvironment.crimsonsnow}
        };
