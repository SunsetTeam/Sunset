...
public class AzariaGenerator extends SnPlanetGenerator {
    ...
    public AzariaGenerator() {
         ...
         {SnEnvironment.crimsonWater, SnEnvironment.crimsonSandWater, SnEnvironment.crimsonDirt, SnEnvironment.crimsonSandWater, SnEnvironment.crimsonSandWater, Blocks.stone, SnEnvironment.crimsonDirt, SnEnvironment.crimsonDirt, SnEnvironment.crimsonDirt, SnEnvironment.crimsonDirt, SnEnvironment.crimsonGrass, SnEnvironment.crimsonGrass, SnEnvironment.crimsonDirt},
         {SnEnvironment.crimsonDeepWater, SnEnvironment.crimsonWater, SnEnvironment.crimsonSandWater, SnEnvironment.crimsonGrass, SnEnvironment.crimsonGrass, Blocks.stone, SnEnvironment.crimsonGrass, SnEnvironment.crimsonDirt, SnEnvironment.crimsonGrass, SnEnvironment.crimsonGrass, SnEnvironment.crimsonSand, SnEnvironment.crimsonGrass, SnEnvironment.crimsonGrass},
         {SnEnvironment.crimsonDeepWater, SnEnvironment.crimsonWater, SnEnvironment.crimsonMoss, SnEnvironment.crimsonDirt, SnEnvironment.crimsonDirt, SnEnvironment.crimsonWater, SnEnvironment.crimsonSandWater, SnEnvironment.crimsonGrass, SnEnvironment.crimsonGrass, Blocks.stone, SnEnvironment.crimsonDirt, SnEnvironment.crimsonGrass, SnEnvironment.crimsonDirt},
    ...
    protected void passRivers(Room fspawn, int x, int y){
        ...
        if(value > 0.12f && !Mathf.within(x, y, fspawn.x, fspawn.y, 12 + rrscl)){
            ...
            if(!(floor == SnEnvironment.crimsonIce || floor == SnEnvironment.crimsonIceSnow || floor == SnEnvironment.crimsonSnow || floor.asFloor().isLiquid)){
                floor = spore ?
                        (deep ? SnEnvironment.crimsonDeepWater : SnEnvironment.crimsonSandWater) :
