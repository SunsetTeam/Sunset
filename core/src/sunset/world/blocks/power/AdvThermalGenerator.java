...
public class AdvThermalGenerator extends ThermalGenerator {
    ...
    public AdvThermalGenerator(String name){
        super(name);
    ...
    public class AdvThermalGeneratorBuild extends ThermalGenerator.ThermalGeneratorBuild {
        public float sum;
