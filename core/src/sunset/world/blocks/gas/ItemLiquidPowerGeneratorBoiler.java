...
public class ItemLiquidPowerGeneratorBoiler extends PowerGenerateBoiler {
    ...
    public ItemLiquidPowerGeneratorBoiler(boolean hasItems, boolean hasLiquids, String name) {
        this(name);
    ...
    public ItemLiquidPowerGeneratorBoiler(String name) {
        super(name);
    }
