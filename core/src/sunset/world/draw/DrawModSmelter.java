...
public class DrawModSmelter extends DrawBlock {
    ...
    public DrawModSmelter() {

    }

    public DrawModSmelter(Color flameColor) {
        this.flameColor = flameColor;
    }

    public DrawModSmelter(boolean topCircle) {
        this.topCircle = true;
    }

    public DrawModSmelter(boolean topCircle, Color flameColor) {
